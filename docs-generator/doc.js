export default [
  ...
  },
  {
    ...
    name: '_',
    description:
      'Provides a mutable, uncapped version of all lodash fp methods - but still flipped and curried. A sort of "practical" version of lodash/fp.',
    tags: ['conversions'],
    // ## Lodash Conversions
  ...
  },
  {
    ...
    description: `Returns an array of arrays, where each one of the arrays has one or more elements of the original array, grouped by the first function received. Similar to Haskell's [groupBy](http://zvon.org/other/haskell/Outputlist/groupBy_f.html).`,
    tags: ['array']
  },
  {
    name: 'toggleElement',
...
braceHighlight(/l+\w/, 'hello world') //-> "he{llo} wor{ld}"`
  ...
  },
  {
    ...
    description:
      'Takes a lens and returns a value/onChange pair that views/sets the lens appropriately. `onChange` sets with `e.target.value`',
    tags: ['lens', 'lens consumption - domLens']
  },
  {
    name: 'domLens.checkboxValues',
    signature: `(value, lens) -> {checked, onChange}`,
    description:
      'Creates an includeLens and maps view to checked and set to `onChange` (set with `e.target.checked`)',
    tags: ['lens', 'lens consumption - domLens']
  },
  {
    name: 'domLens.hover',
