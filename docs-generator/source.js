module.exports = {
  ...
  "pickByIndexed": "let pickByIndexed = function Bu(n, t) {\n  /* [wrapped with _.ary, _.curry, & _.rearg] */\n  if (null == n) return {}\n  var r = c(ve(n), function(n) {\n    return [n]\n  })\n  return (\n    (t = ye(t)),\n    tr(n, r, function(n, r) {\n      return t(n, r[0])\n    })\n  )\n}\n",
  ...
  "findApply": "let findApply = (f, arr) => _.iteratee(f)(_.find(f, arr))\n",
  "flowMap": "let flowMap = (...fns) => _.map(_.flow(...fns))\n",
  ...
  "map": "let map = (f, x) =>\n  (_.isArray(x) ? _.map : _.mapValues).convert({\n    /* [wrapped with _.curry] */\n    cap: false\n  })(f, x)\n",
  ...
  "compactObject": "let compactObject = function Bu(n, t) {\n  /* [wrapped with _.ary, _.curry, _.partial, & _.rearg] */\n  if (null == n) return {}\n  var r = c(ve(n), function(n) {\n    return [n]\n  })\n  return (\n    (t = ye(t)),\n    tr(n, r, function(n, r) {\n      return t(n, r[0])\n    })\n  )\n}\n",
  ...
  "mergeOverAll": "let mergeOverAll = (fns, ...x) =>\n  _.flow(\n    _.over(fns),\n    _.mergeAll\n  )(...x)\n",
  ...
  "stripEmptyObjects": "let stripEmptyObjects = function Bu(n, t) {\n  /* [wrapped with _.ary, _.curry, _.partial, & _.rearg] */\n  if (null == n) return {}\n  var r = c(ve(n), function(n) {\n    return [n]\n  })\n  return (\n    (t = ye(t)),\n    tr(n, r, function(n, r) {\n      return t(n, r[0])\n    })\n  )\n}\n",
  ...
  "compactJoin": "let compactJoin = (join, x) => _.compact(x).join(join)\n",
  "cycle": "let cycle = (a, n) => a[(a.indexOf(n) + 1) % a.length]\n",
  "dotJoin": "let dotJoin = (join, x) => _.compact(x).join(join)\n",
  "dotJoinWith": "let dotJoinWith = fn => x => _.filter(fn, x).join('.')\n",
  ...
  "prefixes": "let prefixes = list => _.range(1, list.length + 1).map(x => _.take(x, list))\n",
  ...
  "replaceElement": "let replaceElement = (a, b, arr) => replaceElementBy(_.isEqual(a), b, arr)\n",
  "replaceElementBy": "let replaceElementBy = (f, b, arr) => _.map(c => (f(c) ? b : c), arr)\n",
  ...
  "makeAndTest": "let makeAndTest = options =>\n  _.flow(\n    makeRegex(options),\n    testRegex\n  )\n",
  ...
  "flatLeaves": "let flatLeaves = (next = traverse) => _.reject(next)\n",
  "flattenTree": "let flattenTree = (next = traverse) => (buildPath = treePath()) =>\n  reduceTree(next)(\n    (result, node, ...x) => _.set([buildPath(node, ...x)], node, result),\n    {}\n  )\n",
  "isTraversable": "let isTraversable = x => _.isArray(x) || _.isPlainObject(x)\n",
  ...
  "traverse": "let traverse = x => isTraversable(x) && !_.isEmpty(x) && x\n",
