...
export let navIcons = ({page, dispatch, responsive}) => (
    <>
      <HStack>
        <NavIcon  name="home" icon={<AiOutlineHome />} type="navigation" 
                  ariaLabel={'navigate to home'} {...{ page, dispatch, responsive }}  
        />
      </HStack>
      <HStack>
        <NavIcon  name="docs" icon={<BsJournalCode/>} type="navigation" 
                  ariaLabel={'navigate to docs'}  {...{ page, dispatch, responsive }} 
        />
      </HStack>
      <HStack>
        <NavIcon
