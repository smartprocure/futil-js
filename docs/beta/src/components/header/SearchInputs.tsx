...
export let SearchInputs = ({input, output, search, toolTipName, toolTipInOut, dispatch, responsive }) => (
    <>
        <Spacer />
        ...
        <Tooltip hasArrow label={<ToolTipLabel {...toolTipInOut} />}>
          <InputGroup  minW={'150px'}  maxW={'100%'}>
            <InputLeftAddon bg={useColorModeValue("icon.light","icon.dark")} w={'50px'}>
            ...
            />
            <InputRightAddon bg={useColorModeValue("icon.light","icon.dark")} w={'50px'}>
