module.exports = {
  ...
  "unwind": "let unwind = (prop, x) => _.map(y => _.set(prop, y, x), _.get(prop, x))\n",
  ...
  "arrayToObject": "let arrayToObject = (k, v, a) =>\n  _97d‍.a('_', _).flow(_97d‍.a('_', _).keyBy(k), _97d‍.a('_', _).mapValues(v))(\n    a\n  )\n",
  "chunkBy": "let chunkBy = (f, array) =>\n  _97d‍\n    .a('_', _)\n    .reduce(\n      (acc, x) =>\n        f(_97d‍.a('_', _).last(acc), x)\n          ? [..._.initial(acc), [..._.last(acc), x]]\n          : [...acc, [x]],\n      [[_97d‍.a('_', _).head(array)]],\n      _97d‍.a('_', _).tail(array)\n    )\n",
  ...
  "encoder": "let encoder = separator => ({\n  encode: compactJoin(separator),\n  decode: _97d‍.a('_', _).split(separator)\n})\n",
  "intersperse": "let intersperse = (f, [x0, ...xs]) =>\n  _97d‍.a('reduceIndexed', reduceIndexed)(\n    (acc, x, i) =>\n      i === xs.length\n        ? [...acc, x]\n        : [...acc, _97d‍.a('callOrReturn', callOrReturn)(f, acc, i, xs), x],\n    [x0],\n    xs\n  )\n",
  "mergeRanges": "let mergeRanges = function() {\n  var n = arguments,\n    e = n[0]\n  if (o && 1 == n.length && ff(e)) return o.plant(e).value()\n  for (var u = 0, n = r ? t[u].apply(this, n) : e; ++u < r; )\n    n = t[u].call(this, n)\n  return n\n}\n",
  "moveIndex": "let moveIndex = (from, to, arr) =>\n  _97d‍\n    .a('_', _)\n    .flow(\n      _97d‍.a('_', _).pullAt(from),\n      _97d‍.a('insertAtIndex', insertAtIndex)(to, arr[from])\n    )(arr)\n",
  "prefixes": "let prefixes = list =>\n  _97d‍\n    .a('_', _)\n    .range(1, list.length + 1)\n    .map(x => _97d‍.a('_', _).take(x, list))\n",
  ...
  "isBlankDeep": "let isBlankDeep = combinator => x => combinator(isBlank, tree().leaves(x))\n",
  ...
  "flatLeaves": "let flatLeaves = (next = traverse) => _fa9‍.a('_', _).reject(next)\n",
  "flattenTree": "let flattenTree = (next = traverse) => (buildPath = treePath()) =>\n  reduceTree(next)(\n    (result, node, ...x) =>\n      _fa9‍.a('_', _).set([buildPath(node, ...x)], node, result),\n    {}\n  )\n",
  "isTraversable": "let isTraversable = x =>\n  _fa9‍.a('_', _).isArray(x) || _fa9‍.a('_', _).isPlainObject(x)\n",
  "keyTreeByWith": "let keyTreeByWith = (next = traverse) =>\n  _fa9‍.a('_', _).curry((transformer, groupIteratee, x) =>\n    _fa9‍.a('_', _).flow(\n      treeToArrayBy(next)(_fa9‍.a('_', _).iteratee(groupIteratee)),\n      _fa9‍.a('_', _).uniq,\n      _fa9‍.a('_', _).keyBy(_fa9‍.a('_', _).identity),\n      _fa9‍.a('_', _).mapValues(group =>\n        transformTree(next)(node => {\n          let matches = _fa9‍.a('_', _).iteratee(groupIteratee)(node) === group\n          transformer(node, matches, group)\n        }, x)\n      )\n    )(x)\n  )\n",
  "leaves": "let leaves = (next = traverse) =>\n  _fa9‍.a('_', _).flow(treeToArray(next), _fa9‍.a('_', _).reject(next))\n",
  "propTreePath": "let propTreePath = prop =>\n  treePath(\n    _fa9‍.a('_', _).flow(treeValues, _fa9‍.a('_', _).map(prop)),\n    _fa9‍.a('slashEncoder', slashEncoder)\n  )\n",
  "reduceTree": "let reduceTree = (next = traverse) =>\n  _fa9‍.a('_', _).curry((f, result, tree) => {\n    walk(next)((...x) => {\n      result = f(result, ...x)\n    })(tree)\n    return result\n  })\n",
  "transformTree": "let transformTree = (next = traverse) =>\n  _fa9‍.a('_', _).curry((f, x) => {\n    let result = _fa9‍.a('_', _).cloneDeep(x)\n    walk(next)(f)(result)\n    return result\n  })\n",
  "traverse": "let traverse = x => isTraversable(x) && !_fa9‍.a('_', _).isEmpty(x) && x\n",
