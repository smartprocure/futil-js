...
exports.matchesSignature = exports.compareDeep = exports.testRegex = exports.flowMap = exports.getUniqueWords = exports.processQuotes = exports.parens = exports.quote = exports.wrap = exports.greaterThanOne = undefined;
...
var processQuotes = exports.processQuotes = function processQuotes(word) {
    return _fp2.default.replace(/(")|(\\")/g, '$2', word);
};
var getUniqueWords = exports.getUniqueWords = _fp2.default.flow(_fp2.default.trim, _fp2.default.split(' '), _fp2.default.compact, _fp2.default.uniq, _fp2.default.without(['and', 'or', 'not']));
