...
import * as F from './string.js'
import { eachIndexed } from './conversion.js'
...
describe('String Functions', () => {
  ...
  it('uniqueStringWith', () => {
    ...
    let stripDigits = arrayToObject(_.replace(/(\d+)$/, ''), () => 1)
    ...
    let appendHiForSomeReason = arrayToObject(_.identity, () => 'hi')
    expect(
